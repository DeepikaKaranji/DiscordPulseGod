        ...
        <div className="Header">
            <header className="Header__info">
                <span className="Header__title">
                    ...
                    <h2>All-seeing insights for your server.</h2>
                </span>
                <div className="Header__link">
                    <a href="https://github.com/DeepikaKaranji/DiscordPulseGod" target="_blank">
                        <img src={Logo} alt="DiscordPulseGod logo" height="60" />
                    </a>
                </div>
            </header>
